...
class TestCourseContext(TestCase):
    ...
    def test_get_info_2(self):
        self.context.query = "Travis Brummett"
        self.context.get_directory_info()
        self.assertEqual("tbrummett@tntech.edu", self.context.entries[0].email)
        self.assertEqual("Bruner Hall (BRUN) 329", self.context.entries[0].building)
    ...
    def test_get_info_multiple(self):
        ...
        self.assertEqual("Jerry", self.context.entries[1].firstname)
    ...
    def test_large_info_2(self):
        self.context.query = "Davis"
        self.context.get_directory_info()
        self.assertEqual(19, len(self.context.entries))
